...
('4년 연속 \'인권경영 인증\' 획득', '2024-11-18', '인권경영 관리 방침과 목표', '실행 체계 등 전문가 심사', '이성철 기자', 'humanrights.JPG'),
('ESG A등급 받은 비결', '2023-09-24', '예술 작품 탄생', '6년 연속 A등급', '뉴스투데이=김소희 기자', 'ESG.JPG'),
('경영 전면 나서는 후계자', '2024-11-16', '연말 임원 인사에서 재계 후계자들의', '올해 재계 인사 트렌드는 후계자 승진', '김문수 기자', 'HD.JPEG'),
