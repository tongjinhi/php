...
('the backroom', 'WAL', '1.20.1', '2024-07-08', '백룸에서부터 탈출하세요!', 'backroom.png'),
('time keeper', '리스빈', '1.13.3', '2024-07-09', '시간을 지키는 타임키퍼의 위대한 여정!', 'time keeper.png'),
('수많은 별들 중에', '콜룰라', '1.12.2', '2024-07-10', '로맨스 소설', 'stars.png'),
('팬션 살인사건', '별돌맹이', '1.7.10', '2024-07-11', '팬션 살인사건 과연 범인은?', 'merder.png');
